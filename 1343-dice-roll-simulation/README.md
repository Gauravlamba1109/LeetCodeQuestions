<h2><a href="https://leetcode.com/problems/dice-roll-simulation">1343. Dice Roll Simulation</a></h2><h3>Hard</h3><hr><p>A die simulator generates a random number from <code>1</code> to <code>6</code> for each roll. You introduced a constraint to the generator such that it cannot roll the number <code>i</code> more than <code>rollMax[i]</code> (<strong>1-indexed</strong>) consecutive times.</p>
